document.addEventListener('DOMContentLoaded', function() {
  /* --- Collegamento Header: Login e Register --- */
  // Quando l'utente clicca sul pulsante "Login" nell'header, reindirizza a login.html
  ...
  // Quando l'utente clicca sul pulsante "Register" nell'header, reindirizza a register.html
